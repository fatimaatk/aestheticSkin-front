                ...
                <div className="mb-3 shadow-lg rounded text-gray-600">
                  ...
                  <label className="flex border-b border-gray-200 h-12 py-3 items-center">
                    ...
                    <input
                      ...
                      onChange={(e) => setCodePostalDelivery(e.target.value)}
                    />
                  </label>
                  <label className="flex border-b border-gray-200 h-12 py-3 items-center">
                  ...
                  <div className="mb-3  shadow-lg rounded text-gray-600">
                    ...
                    <label className="flex border-b border-gray-200 h-12 py-3 items-center">
                      ...
                      <input
                        ...
                        required=""
                        onChange={(e) =>
                          differentBilling && setPrenomShipping(e.target.value)
                        }
                      />
                    </label>
                    <label className="flex border-b border-gray-200 h-12 py-3 items-center">
                      ...
                      <input
                        ...
                        placeholder={user.adresse}
                        onChange={(e) =>
                          differentBilling && setAdresseShipping(e.target.value)
                        }
                      />
                    </label>
                    <label className="flex border-b border-gray-200 h-12 py-3 items-center">
                    ...
                    <label className="flex border-b border-gray-200 h-12 py-3 items-center">
                      ...
                      <input
                        ...
                        placeholder={user.ville}
                        onChange={(e) =>
                          differentBilling && setVilleShipping(e.target.value)
                        }
                      />
                    </label>
                  </div>
